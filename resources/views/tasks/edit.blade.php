...
<div class="task-feed">
    <div class="form-card" style="max-width:560px;">
        ...
        <form action="{{ route('tasks.update', $task) }}" method="POST" enctype="multipart/form-data">
            ...
            @if($task->photo_path)
                <div class="form-group">
                    ...
                    <div style="position:relative; border-radius:8px; overflow:hidden; margin-bottom:8px;">
                        <img src="{{ asset('storage/' . $task->photo_path) }}" alt="Current photo"
            ...
            <div class="form-group">
                <label>{{ $task->photo_path ? 'Replace photo' : 'Photo' }} <span style="font-size:11px; color:var(--tx3); font-weight:400;">(optional)</span></label>
                <div id="uploadBox"
                    ...
                    <i class="ti ti-photo-plus" style="font-size:24px; color:var(--tx3); display:block; margin-bottom:6px;"></i>
            ...
            <div class="task-actions" style="margin-top:20px;">
                ...
                <a href="{{ route('profile.edit') }}" class="btn-skip"
