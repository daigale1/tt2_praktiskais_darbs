    ...
    <div class="form-card" style="max-width:560px;">
        ...
        <form action="{{ route('tasks.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px;">
                ...
                <div class="form-group">
                    {{-- scheduled_at is the correct column name in Deniss's migration --}}
                    <label for="scheduled_at">Time <span style="font-size:11px; color:var(--tx3); font-weight:400;">(optional)</span></label>
            ...
            <div class="form-group">
                <label>Photo <span style="font-size:11px; color:var(--tx3); font-weight:400;">(optional)</span></label>
                <div id="uploadBox"
                    ...
                    <i class="ti ti-photo-plus" style="font-size:28px; color:var(--tx3); display:block; margin-bottom:8px;"></i>
                ...
                <input type="file" id="photoInput" name="photo_path" accept="image/*" style="display:none;" onchange="previewPhoto(this)">
                <div id="previewWrap" style="display:none; position:relative; margin-top:10px; border-radius:8px; overflow:hidden;">
                    <img id="previewImg" src="" alt="Preview" style="width:100%; height:160px; object-fit:cover; display:block; border-radius:8px;">
            ...
            <div class="task-actions" style="margin-top:20px;">
                ...
                <a href="{{ route('feed.index') }}" class="btn-skip"
